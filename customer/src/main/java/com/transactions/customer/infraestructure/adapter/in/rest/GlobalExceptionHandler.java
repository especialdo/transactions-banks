...
import com.transactions.customer.domain.exception.BusinessException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleTransaction(
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ErrorResponse.of("Error en la transacción", 500, List.of(ex.getMostSpecificCause().getMessage()),
                        request.getRequestURI()));
    }
